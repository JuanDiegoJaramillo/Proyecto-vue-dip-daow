  ...
  <div class="min-h-screen bg-gray-100 dark:bg-gray-900 py-10 px-6">
    ...
    <div class="max-w-3xl mx-auto bg-white dark:bg-gray-800 shadow-lg rounded-lg p-6">
      ...
      <div class="text-center mb-6">
        <h1 class="text-2xl font-bold text-gray-800 dark:text-gray-100">Perfil del Invitado</h1>
...
import servicesInvitados from '../services'
...
const cargarDatos = async () => {
  const respuesta = await servicesInvitados.DetallesUsuarioInvitado()

  if (respuesta.status == 200) {
    let datos = respuesta.data[0]
    ;(formData.NOMBRE = datos.NOMBRE),
      (formData.DEPENDENCIA = datos.DEPENDENCIA),
