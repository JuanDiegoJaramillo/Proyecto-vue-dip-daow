<template>
  <main class="h-full overflow-y-auto">
    <div class="container px-6 mx-auto grid">
      <!--  -->
      <!-- titulo -->
      <h1 class="mb-1 text-4xl font-bold dark:text-gray">Gestion Mienbros</h1>
      <BreadCrumb home="Asisterncia Mienbro" modulo="Gestion" />
      <div class="grid grid-cols-2 my-6 font-bold dark:text-gray">
        <div class="flex items-center">
          <h2 class="mb-1 text-4xl font-bold dark:text-gray">Listado Asistencia Miembros</h2>
        </div>
        <div>
      ...
      <AgregarLink
        titulo="Asistencia Miembros"
        ruta="/asistencias/crear"
        titulo-link="Agregar"
      ></AgregarLink>
          ...
          <table class="w-full whitespace-no-wrap border-black dark:border-slate-300">
            <thead>
              ...
              >
                ...
                <th class="px-4 py-3">Miembros (ID Miembros)</th>
                <th class="px-4 py-3">Estado de Asistencia</th>
            ...
            <tbody class="bg-white divide-y dark:divide-gray-700 dark:bg-gray-800">
              ...
              >
                  ...
                  <div class="flex items-center text-sm">
                    ...
                    <div class="relative hidden w-8 h-8 mr-3 rounded-full md:block">
                      <div
                        ...
                        aria-hidden="true"
                      >
                        <p class="font-semibold">{{ asistencia.sesionId }}</p>
                      </div>
                    </div>
                  </div>
                </td>
                ...
                <td class="px-4 py-3 text-sm">
                  <div class="flex">
                    <router-link
                      :to="`/asistencia/actualizar/${asistencia.miembroId}`"
...
function cargarDatos() {
  asistencias.value = [
    { sesionId: 101, miembroId: 1, estadoAsistencia: 'Presente' },
    { sesionId: 102, miembroId: 2, estadoAsistencia: 'Ausente' }
    // Agregar más registros de asistencia aquí
  ]
}
